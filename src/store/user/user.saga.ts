...
export function* getSnapshotFromUserAuth(userAuth: User, additionalDetaild?: AdditionalInformation) {
    try {
...
export function* signInWhithEmail({ payload: { email, password } }: EmailSignInStart) {
    try {
